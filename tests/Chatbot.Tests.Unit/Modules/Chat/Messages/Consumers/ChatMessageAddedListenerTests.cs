...
public class ChatMessageAddedListenerTests
{
    ...
    private readonly ChatMessageAddedListener _sut;

    public ChatMessageAddedListenerTests()
    {
        ...
        _sut = new ChatMessageAddedListener(
            _messageServiceMock,
            _lockBrokerMock,
            _loggingBrokerMock,
            _clockMock
