...
namespace MyProject.Tests.Unit.Services.Foundations.Students
{
    public partial class StudentServiceTests
    {
        ...
        public async Task ShouldThrowValidationExceptionOnAddIfStudentIsNullAndLogItAsync()
        {
            ...
            // when
            ValueTask<Student> addStudentTask = this.studentService.AddStudentAsync(nullStudent);
            ...
            this.storageBrokerMock.Verify(
                broker => broker.InsertStudentAsync(It.IsAny<Student>()),
                Times.Never
            );
        ...
        )
        {
            ...
            invalidStudentException.AddData(key: nameof(Student.Id), values: "Id is required");

            invalidStudentException.AddData(key: nameof(Student.Name), values: "Text is required");
