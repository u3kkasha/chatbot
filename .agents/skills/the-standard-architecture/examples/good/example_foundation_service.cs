...
namespace MyProject.Services.Foundations.Students
{
    ...
    public partial class StudentService : IStudentService
    {
        ...
        public ValueTask<IQueryable<Student>> RetrieveAllStudentsAsync() =>
            TryCatch(async () => await this.storageBroker.SelectAllStudentsAsync());
...
namespace MyProject.Services.Foundations.Students
{
    public partial class StudentService
    {
        ...
        private async ValueTask<StudentDependencyValidationException> CreateAndLogDependencyValidationException(
            Xeption exception
        )
        {
