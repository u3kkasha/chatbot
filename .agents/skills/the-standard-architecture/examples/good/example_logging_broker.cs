...
namespace MyProject.Brokers.Loggings
{
    ...
    public class LoggingBroker : ILoggingBroker
    {
        ...
        public async ValueTask LogTraceAsync(string message) => this.logger.LogTrace(message);

        public async ValueTask LogDebugAsync(string message) => this.logger.LogDebug(message);
